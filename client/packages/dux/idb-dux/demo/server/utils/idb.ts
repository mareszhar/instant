...
// Nuxt 4 / Nitro 2 still rides h3 v1, so this demo owns the small adapter over
// `@mszr/idb-dux/server`. Routes still get the delightful shape: one factory at
// module scope; one `await useServerIdb(event, mode)` per route.
